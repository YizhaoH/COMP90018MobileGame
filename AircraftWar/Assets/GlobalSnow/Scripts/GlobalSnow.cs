...
namespace GlobalSnowEffect {
    ...
    public partial class GlobalSnow : MonoBehaviour {
        ...
        void UpdateSnowData4() {
            Shader.SetGlobalVector(ShaderParams.GlobalSnowData4, new Vector4(1f / _footprintsScale, _footprintsObscurance, 0, 1.0f - (_billboardCoverage * Mathf.Min(_snowAmount, 1f))));
        }

        void UpdateSnowData5() {
            Shader.SetGlobalVector(ShaderParams.GlobalSnowData5, new Vector4(_slopeThreshold - 0.2f, 5f + _slopeSharpness * 10f, _slopeNoise * 5f, _distanceSlopeThreshold - 0.2f));
        }
