...
namespace GlobalSnowEffect {
    ...
    public class GlobalSnowEditor : Editor {
        ...
        SerializedProperty defaultExclusionLayer, coverageMask, coverageMaskTexture, coverageMaskWorldSize, coverageMaskWorldCenter, groundCoverage, coverageUpdateMethod, coverageDepthDebug;
